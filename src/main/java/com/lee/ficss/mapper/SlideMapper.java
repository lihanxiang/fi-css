...
public interface SlideMapper {
    ...
    //Insert
    @Insert("INSERT INTO slide (slide_file_id, submitter_id, author, slide_title, slide_file_path, commit_time)" +
            "VALUE (#{slideFileID}, #{submitterID}, #{author}, #{slideTitle}, #{slideFilePath}, #{commitTime})")
